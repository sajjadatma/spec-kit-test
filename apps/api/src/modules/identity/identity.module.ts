...
@Module({ controllers: [AuthController, PreferencesController, UsersController, ProductsController, PricingController, UploadsController, ProductImagesController], providers: [IdentityService] })
